  ...
  return (
    <section className="h-[1000px] mx-auto pl-8 pr-8 sm:pr-0 sm:pl-20 max-w-full w-fullScreen flex items-center relative">
      <div className="flex flex-col ml-0 md:ml-10 xl:ml-0 gap-8 z-[1] font-Poppins">
        <h2 className="font-bold text-[14px] md:text-[18px] text-[#DF6951] uppercase">
          Best Destinations around the world
        </h2>
        <h1 className="text-[#181E4B] font-Volkhov font-bold text-[38px] md:text-[84px] leading-[70px] md:leading-[89px] relative">
          Travel, enjoy <br />
          and live a new <br />
          and full life
        ...
        <h5 className="font-semibold text-[14px] md:text-[18px] leading-[30px] text-[#5E6282] tracking-wider">
        ...
        <div className="flex flex-col items-start sm:items-center sm:flex-row gap-11">
          <button className="py-3 sm:py-5 px-5 sm:px-7 rounded-xl bg-[#F1A501] font-semibold font-sans shadow-xl shadow-[#df695166] text-white text-[15px] sm:text-[18px] transition-transform duration-300 hover:scale-105">
            Find out more
          </button>
